...
from torchvision.transforms.v2 import Compose, Normalize, Resize, CenterCrop, ToDtype, RandomHorizontalFlip, RandomVerticalFlip
import os
import math
import torch
...
def run(
    ...
    training_dataset = EmognitionDataset(
        csv_file=csv_file,
        time_window = 5.0, #sec
    ...
    validation_dataset = EmognitionDataset(
        csv_file=csv_file,
        time_window = 5.0, #sec
        video_transform=video_preprocessor,
        eeg_transform = AbsFFT(dim=-2),
