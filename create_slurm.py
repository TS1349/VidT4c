...
srun python -u ./runner.py \\\n\
        ...
        --experiment_name "{model}_{dataset}_lr{learning_rate[2:]}_bs{batch_size*num_gpus}_{p_string}"\\\n\
        --dataset "{dataset}"\\\n\
        --model "{model}"\\\n\
...
if "__main__" == __name__:
    ...
    file_name = f"./{'debug_' if args.debug else ''}{args.model}_{args.dataset}_lr{args.learning_rate[2:]}_bs{args.batch_size*args.num_gpus}{p_string}.slurm"
