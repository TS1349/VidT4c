...
from .rope import *
from .tokenization import FlexiPatchEmbed, FlexiPosEmbed, resample_patch_embed, vanilla_resample_patch_embed
import random
...
class AudioMamba(nn.Module):
    def __init__(self, args,
        ...
        # )
            ...
            # self.a_head.apply(segm_init_weights)
        ...
        if aum_pretrain:
            ...
            if weights['head.weight'].shape[0] != self.num_classes:
