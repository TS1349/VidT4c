...
class DGCNN_Model(nn.Module):
    def __init__(self, args, num_electrodes=62, in_channels=5, output_dim=tuple, k=2, relu_is=1, layers=None, dropout_rate=0.5):
        ...
        self.fc2 = nn.Linear(256, self.num_class, bias=True)
